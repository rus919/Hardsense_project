		...
		while True:
				...
				if client and engine and pm:
					try:
						...
						#localPlayer = pm.read_int(engine_pointer + dwClientState_GetLocalPlayer)
					except:
				...
				# 							int(((new_angle.y - view_angley) / sensitivity) / -0.022),
				# 							int(((new_angle.x - view_anglex) / sensitivity) / 0.022),
				# 							0, 0)
				# 		g_oldpunchx = punchx
				# 		g_oldpunchy = punchy
