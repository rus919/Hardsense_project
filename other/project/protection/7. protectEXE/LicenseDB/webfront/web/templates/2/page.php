...
<body><div style="background-image:url('<?php echo $template_path;?>top.png');" id="tt"><div id="tt2">
	<img id="nl" src="<?php echo $template_path;?>nl.png" border="0"/>
	<div id="nav" style="background-image:url('<?php echo $template_path;?>nav.png');">
	</div>
	<div id="select_lang"><?php 
